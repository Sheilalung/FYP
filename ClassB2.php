...
<title>Class B2</title>
<link rel="stylesheet" href="./css/Classb2.css">
...
<body>
    ...
    <section id="classD">
        <div class="classD container">
            <div><h1>Class <span>B2</span> (Motorcycle)</h1></div>
            <div class="item">
                <div class="row">
                    <img src="./user/image/Motorcycle1.jpg" alt="Safety Helmet">
                </div>
                <div class="row">
                    <img src="./user/image/Motorcycle2.jpg" alt="Motorcycle Seat">
                </div>
                <div class="row">
                    <img src="./user/image/Motorcycle3.jpg" alt="Motorcycle">
                </div>
            </div>
            <div class="section">
            <div class="box">
				...
				<div class="text">
				<p>Non MYKAD Holders Price - RM 800*</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
            ...
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>Qualified Age for Motorcycle License (B2) is 16 years old</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
            ...
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>Maybank Credit Card Ezypay Available - Up to 6 Months</p>
				</div>
            </div>
        </div>
        </div>
