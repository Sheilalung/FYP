...
<title>Class B</title>
<link rel="stylesheet" href="./css/Class_B.css">
...
<body>
    ...
    <!-- License Section -->
    <section id="classD">
        <div class="classD container">
            <div><h1>Class <span>B</span> (Superbike)</h1></div>
            <div class="item">
                <div class="row">
                    <img src="./user/image/superbike1.jpg" alt="Safety Helmet">
                </div>
                <div class="row">
                    <img src="./user/image/superbike2.jpg" alt="Motorcycle Seat">
                </div>
                <div class="row">
                    <img src="./user/image/superbike3.jpg" alt="Motorcycle">
                </div>
            </div>
            <div class="section">
            <div class="box">
				...
				<div class="text">
				<p>Non MYKAD Holders Price - RM 1300*</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>Discount RM100 for Register Online</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>Additional RM100 Discount for L License Holder</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>RM200 Charges For Transportation Service To Your Doorstep</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>Free Transportation from Selected Pick Up Points</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>Qualified Age for Superbike License (BFull) is 16 years old</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>FREE Helmet & Vest</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>Payment can be made in 2 installment</p>
				</div>
            </div>
            <div class="box">
				<div class="icon"><i class="fa fa-check" aria-hidden="true"></i></div>
				<div class="text">
				<p>Maybank Credit Card Ezypay Available - Up to 12 Months</p>
				</div>
            </div>
        </div>
        </div>
