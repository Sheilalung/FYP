...
<body>
    ...
    <section id="services">
        <div class="services container">
            <div>
             <h1>Services</h1>
             <h2>Best Service, Right Time, Right People</h2>
            </div>
        </div>
    </section>
    ...
    <section id="content">
        <div class="content container">
            <div class="service-top">
                <p>As a service provider, Driving Lesson Booking System 
                offers packages of driving lessons from theory test, 
                practical test, to road test preparation for Car-Manual, 
                Automatic or Motorcycle that suit individuals’ needs and 
                preference. In Driving Lesson Booking System, we strive to provide 
            ...
            <div class="service-bottom">
                ...
                <h2>License</h2>
                    ...
                    <p><a href="Class00.php">Class I (Tractor)</a></p>
                </div>
                <div class="service-item">
                    <div class="icon"><img src="https://img.icons8.com/bubbles/50/000000/car.png"/>
                </div>
