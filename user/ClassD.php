...
<body>
    ...
    <section id="classD">
        <div class="classD container">
            <div><h1>Class <span>D/DA</span> (Car-Manual)</h1></div>
            <div class="item">
                <div class="row">
                    <img src="./image/manual1.jpg" alt="Manual Car Gear">
                </div>
                <div class="row">
                    <img src="./image/manual2.jpg" alt="Car break">
                </div>
                <div class="row">
                    <img src="./image/manual3.jpg" alt="Perodua Axia E Manual">
                </div>
            </div>
            <div class="section">
            <div class="box">
