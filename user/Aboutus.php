...
<body>
    ...
    <section id="aboutus">
        <div class="aboutus container">
            <div>
             <h1>About Us</h1>
             <h2>Best Driving Lesson Booking System!</h2>
            </div>
        </div>
    </section>
    ...
    <section id="content">
        <div class="content container">
            <div>
             <p>Established in 2021, Driving Lesson Booking System was licensed 
            and awarded as the <span>BEST SEARCHING WEBSITE &#38; 5 STAR Rated Driving lesson 
            booking system </span> by the Road Transport Department of Malaysia. Comprehensively 
            equipped with professionally built driving and riding circuit 
            facilities, our office are located in Bandar Sungai Long &#38; Bandar 
            Mahkota Cheras. <br><br>
            
            We are committed in providing the Best Driving Institute services 
            &#38; Best Driver’s Education services for our Local, with strong 
            focus on Safe Driving and observing road rules and laws at all 
            times and in under any circumstances.</p>
            </div>
            <div class="award">
                <div class="award-img"><img src="./image/awards.jpg" alt="award"></div>
            </div>
        </div>
    </section>
