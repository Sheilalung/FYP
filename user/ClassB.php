...
<title>Class B</title>
<link rel="stylesheet" href="./css/Classb.css">
...
<body>
    ...
    <section id="classD">
        <div class="classD container">
            ...
            <div class="item">
                <div class="row">
                    <img src="./image/superbike1.jpg" alt="Safety Helmet">
                </div>
                <div class="row">
                    <img src="./image/superbike2.jpg" alt="Motorcycle Seat">
                </div>
                <div class="row">
                    <img src="./image/superbike3.jpg" alt="Motorcycle">
                </div>
            </div>
            <div class="section">
            <div class="box">
